...
struct Params { counts: vec4<u32>, physics: vec4<f32>, world: vec4<f32>, view: vec4<f32>, timing: vec4<f32>, flags: vec4<u32>, trails: vec4<f32>, trail_view: vec4<f32>, behavior: vec4<f32>, cycle: vec4<f32>, sampling: vec4<f32> }
